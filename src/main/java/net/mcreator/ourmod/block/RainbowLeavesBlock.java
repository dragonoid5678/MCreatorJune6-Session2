...
public class RainbowLeavesBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:rainbow_leaves")
	public static final Block block = null;
	public RainbowLeavesBlock(OurmodModElements instance) {
		super(instance, 29);
	}
