...
public class RuppeesOreBlockBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:ruppees_ore_block")
	public static final Block block = null;
	public RuppeesOreBlockBlock(OurmodModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruppees_ore_block");
		}
