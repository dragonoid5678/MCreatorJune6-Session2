...
public class NoahsTreeBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:noahs_tree")
	public static final Block block = null;
	public NoahsTreeBlock(OurmodModElements instance) {
		super(instance, 53);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(LogansCoolItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
