...
public class GraasssBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:graasss")
	public static final Block block = null;
	public GraasssBlock(OurmodModElements instance) {
		super(instance, 45);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("graasss", "graasss", blockAt -> {
