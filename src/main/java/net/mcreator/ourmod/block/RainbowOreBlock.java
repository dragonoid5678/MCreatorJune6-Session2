...
public class RainbowOreBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:rainbow_ore")
	public static final Block block = null;
	public RainbowOreBlock(OurmodModElements instance) {
		super(instance, 46);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("rainbow_ore", "rainbow_ore", blockAt -> {
