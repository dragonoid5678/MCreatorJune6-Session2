...
public class PrupleStoneBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:pruple_stone")
	public static final Block block = null;
	public PrupleStoneBlock(OurmodModElements instance) {
		super(instance, 30);
	}
