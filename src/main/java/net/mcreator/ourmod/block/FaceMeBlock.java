...
public class FaceMeBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:face_me")
	public static final Block block = null;
	public FaceMeBlock(OurmodModElements instance) {
		super(instance, 7);
	}
