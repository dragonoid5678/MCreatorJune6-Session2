...
public class BethesdaBlockBlock extends OurmodModElements.ModElement {
	@ObjectHolder("ourmod:bethesda_block")
	public static final Block block = null;
	public BethesdaBlockBlock(OurmodModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bethesda_block");
		}
